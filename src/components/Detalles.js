...
function Detalles(){
    return(
        <div className="centrar">
            <h2 className="text-white text-center">Servicios y Caracteristicas</h2>
            <table className="table table-borderless">
                <tbody>
                    ...
                    <tr>
                        <td className="w-50 text-center">
                            <svg class="bi bi-calendar-check-fill text-warning" width="1.5em" height="1.5em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <td className="w-50 text-center">
                            <svg class="bi bi-building text-warning" width="1.5em" height="1.5em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
